...
function Carousel({ images }) {
  return (
    <div className="border border-1" style={{ width: "100%", objectFit: "cover" }}>
      <div id="carouselExampleDark" className="carousel carousel-dark slide" style={{ height: "100%" }} data-bs-ride="carousel">
  ...
  return (
    <div className="container-sm d-flex flex-lg-row  flex-column mt-4 gap-5">
      ...
      <div className="d-flex flex-column gap-3">
        ...
        <div className="d-flex flex-column gap-3">
          <span className="text-danger">
            Stocks: <span className="text-success">{item.stock || ""}</span>
          </span>
